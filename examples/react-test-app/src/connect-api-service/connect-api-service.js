...
export class ConnectAPIService {
  ...
  loadMembers(clientLocale) {
    return this.dataSource.loadMembers(clientLocale)
  }
  /**
   *
  ...
  loadMemberByGuid(memberGuid, clientLocale) {
    return this.dataSource.loadMemberByGuid(memberGuid, clientLocale)
  }
  ...
  createSupportTicket(ticket) {
    ...
    // Update the ticket to include replay_url
    const updatedTicket = {
      ...ticket,
      replay_url: replayUrl,
    }

    return this.dataSource.createSupportTicket(updatedTicket)
  }
   ...
   * @returns {Promise<Array>} - API Response with an Array of institutions
   */
  loadDiscoveredInstitutions(query) {
    return this.dataSource.loadDiscoveredInstitutions(query)
  }
