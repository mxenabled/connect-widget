...
const ActionTypes = {
  ...
  UPDATE_ACCOUNTS_AFTER_CONNECTING: 'connections/update_accounts_after_connecting',
}
...
const dispatcher = (dispatch) => ({
  loadConnections: (config) => dispatch({ type: ActionTypes.LOAD_CONNECTIONS, payload: config }),
