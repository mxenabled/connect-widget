export const ActionTypes = {
  ...
  RESET_WIDGET_NO_ELIGIBLE_ACCOUNTS:
    "connect/reset_widget_no_eligible_accounts",
...
export const loadConnect = (config = {}) => ({
...
export const selectInstitution = (guid) => ({
...
export const initializeJobSchedule = (
  member,
  job,
  config,
  isComboJobsEnabled
...
export const stepToUpdateCredentials = () => ({
  type: ActionTypes.STEP_TO_UPDATE_CREDENTIALS,
});
export const stepToConnecting = () => ({
  type: ActionTypes.STEP_TO_CONNECTING,
});
export const stepToAddManualAccount = () => ({
  type: ActionTypes.STEP_TO_ADD_MANUAL_ACCOUNT,
});
...
export const stepToMicrodeposits = () => ({
  type: ActionTypes.STEP_TO_MICRODEPOSIT,
});
