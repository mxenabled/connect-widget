...
import { dispatcher as appDispatcher } from 'src/redux/actions/App'
...
/**
 * The 'x-inter' headers are just for security to fingerprint requests
 * We need these headers to detect credential stuffing attacks
 * See https://gitlab.mx.com/mx/connect/issues/279 for more details
 */
export const credentialStuffingPreventionHeaders = {
...
const mxAxios = axios.create({
  headers: {
    ...
    ...credentialStuffingPreventionHeaders,
  },
  validateStatus,
})
