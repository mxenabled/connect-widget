...
import { render, screen, waitFor, fireEvent } from 'src/connect/utilities/testingLibrary'
import { server } from 'src/connect/services/testServer'
import { FAVORITE_INSTITUTIONS, SEARCHED_INSTITUTIONS } from 'src/connect/services/mockedData'
import { Search, buildSearchQuery, getSuggestedInstitutions } from 'src/connect/views/search/Search'
import { VERIFY_MODE, TAX_MODE, AGG_MODE } from 'src/connect/const/Connect'
import { SEARCH_PER_PAGE_DEFAULT, SEARCH_PAGE_DEFAULT } from 'src/connect/views/search/consts'
import { ApiEndpoints } from 'src/connect/services/FireflyDataSource'
...
describe('Search View', () => {
  describe('Search component', () => {
    const defaultProps = {
      ...
      onAddManualAccountClick: jest.fn(),
      onInstitutionSelect: jest.fn(),
      usePopularOnly: true,
      isMicrodepositsEnabled: true,
      stepToMicrodeposits: jest.fn(),
    }
