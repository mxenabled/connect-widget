...
import { REFERRAL_SOURCES, VERIFY_MODE } from 'src/connect/const/Connect'
 ...
 */
  ...
  addMember(memberData, connectConfig = {}, appConfig = {}, isHuman = false) {
    ...
    /* When creating new members in Verify Mode, Background Aggregation is DISABLED by default.
       ...
       See the addMember tests for more info: src/connect/services/__tests__/ConnectAPIService.test.js
    */
