...
import * as analytics from 'reduxify/reducers/analyticsSlice'
import useAnalyticsPath from 'src/connect/hooks/useAnalyticsPath'

jest.spyOn(analytics, 'addAnalyticPath')
jest.spyOn(analytics, 'removeAnalyticPath')
jest.spyOn(analytics, 'sendAnalyticPath')
