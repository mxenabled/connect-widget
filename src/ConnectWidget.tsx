...
import { addAnalyticPath, removeAnalyticPath } from 'reduxify/reducers/analyticsSlice'
...
export class ConnectWidget extends React.Component<ConnectProps, ConnectState> {
  static defaultProps = {
    onAnalyticEvent: () => {},
    onAnalyticPageview: () => {},
    showPadding: true,
...
const mapDispatchToProps = combineDispatchers(
  (dispatch: (arg0: { payload?: any; type: string }) => any) => ({
    ...
    loadConnect: (config: {} | undefined) => dispatch(connectActions.loadConnect(config)),
...
export default withProvider(connector(ConnectWidget))
